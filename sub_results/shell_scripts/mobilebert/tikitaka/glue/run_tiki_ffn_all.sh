...
$PYTHON $SCRIPT --task rte --n-trials 30 $COMMON \
  --study-name mobilebert_glue_tiki_rte_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
...
$PYTHON $SCRIPT --task mrpc --n-trials 30 $COMMON \
  --study-name mobilebert_glue_tiki_mrpc_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
...
$PYTHON $SCRIPT --task stsb --n-trials 30 $COMMON \
  --study-name mobilebert_glue_tiki_stsb_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
...
$PYTHON $SCRIPT --task cola --n-trials 30 $COMMON \
  --study-name mobilebert_glue_tiki_cola_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
...
$PYTHON $SCRIPT --task sst2 --n-trials 30 $COMMON \
  --study-name mobilebert_glue_tiki_sst2_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
...
$PYTHON $SCRIPT --task qnli --n-trials 10 $COMMON \
  --study-name mobilebert_glue_tiki_qnli_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
...
$PYTHON $SCRIPT --task qqp --n-trials 10 $COMMON \
  --study-name mobilebert_glue_tiki_qqp_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
...
$PYTHON $SCRIPT --task mnli --n-trials 10 $COMMON \
  --study-name mobilebert_glue_tiki_mnli_bs64_sgd_nowd_nomom_nonest_ffn${S} \
  2>&1 | tee -a $LOG
