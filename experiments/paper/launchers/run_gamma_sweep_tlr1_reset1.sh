#!/bin/bash
# Gamma sweep: transfer_lr=1.0 (fixed), reset=1 (fixed)
...
RESULTS_DIR="${RESULTS_DIR:-results/paper/gamma_sweep_tlr1_reset1}"
...
echo "=== Gamma Sweep: transfer_lr=1.0, reset=1 ==="
...
base = os.environ.get("RESULTS_DIR", "results/paper/gamma_sweep_tlr1_reset1")
gammas = [0.01, 0.05, 0.1, 0.3, 0.5, 1.0]
