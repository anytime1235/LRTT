...
# Fast tile: ConstantStep, w_max=0.25, 12-bit (dw_min=1.2207e-04)
# Slow tile: ConstantStep, w_max=1.0, 10-bit
set -euo pipefail
...
TAG="cs_g0.0_r1_wmax025_12b"

echo "================================================================="
echo "  TTv1: gamma=0, reset=1.0, transfer_lr=1.0"
echo "  Fast tile: ConstantStep, w_max=0.25, 12b (dw_min=1.2207e-04)"
echo "  Slow tile: ConstantStep, w_max=1.0, 10b"
...
CUDA_VISIBLE_DEVICES=$GPU $PYTHON paper_experiment.py \
    ...
    --batch-size 16 \
    --grad-accum-steps 3 \
    --epochs $EPOCHS --n-bits 12 --n-bits-slow 10 \
    --gamma 0 \
