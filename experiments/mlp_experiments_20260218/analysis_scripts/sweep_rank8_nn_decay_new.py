#!/usr/bin/env python3
"""Rank=8 Transfer Every Sweep - DECAY mode (NEAREST NEIGHBOR).

Uses nearest neighbor strategy for lr/tlr selection.
Fixed rank=8, sweep 28 NEW transfer_every values with 3 trials each (±30%).
Baseline hyperparameters from rank=8, te=100 decay sweep (best: 96.92%).
...
def main():
    ...
    results_dir = "/root/results/rank8_nn_decay"
    ...
    print("=" * 70)
    print("RANK=8 TRANSFER_EVERY SWEEP - DECAY MODE (NEAREST NEIGHBOR)")
    print("=" * 70)
