#!/usr/bin/env python3
"""Rank=8 Transfer Every Sweep - HYBRID mode (NEW POINTS ONLY).

Fixed rank=8, sweep 28 NEW transfer_every values with 3 trials each.
...
def main():
    # Load configs
    with open('/root/rank8_newte_sweep_configs.json', 'r') as f:
        sweep_config = json.load(f)

    results_dir = "/root/results/rank8_newte_hybrid"
    ...
    print("=" * 70)
    print("RANK=8 TRANSFER_EVERY SWEEP - HYBRID MODE (NEW POINTS)")
    print("=" * 70)
