#!/usr/bin/env python3
"""Rank=8 Transfer Every Sweep - DECAY mode (NEW POINTS ONLY).
...
def main():
    ...
    results_dir = "/root/results/rank8_newte_decay"
    ...
    print("=" * 70)
    print("RANK=8 TRANSFER_EVERY SWEEP - DECAY MODE (NEW POINTS)")
    print("=" * 70)
