#!/bin/bash
#
# Monitor LRTT-LoRA Sweep Progress (FP-LoRA Mode)
#
# Usage: bash monitor_sweep_progress_fp.sh
#

RESULTS_DIR=/data/results/lora_fp

echo "================================================================================"
echo "LRTT-LoRA Sweep Progress Monitor (FP-LoRA Mode)"
echo "================================================================================"
...
ps aux | grep "sweep_lrtt_lora_optuna.py" | grep "fp_lora" | grep -v grep || echo "No FP-LoRA sweep processes running"
