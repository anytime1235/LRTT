#!/usr/bin/env python3
"""Optuna sweep: Digital MDMLP with only classifier (head.Linear) trainable.
...
def parse_args():
    ...
    parser.add_argument("--study-name", type=str, default="mdmlp_digital_head_only")
    parser.add_argument("--storage", type=str, default=None)
    parser.add_argument("--output-dir", type=str, default="./output/sweep_head_only")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("HEAD-ONLY SWEEP COMPLETE")
    print("=" * 80)
