#!/usr/bin/env python3
"""Optuna sweep for MDMLP + LRTT with decay reinit, 200ep cosine annealing.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Optuna sweep: LRTT decay reinit, 200ep cosine")
    ...
    parser.add_argument("--output-dir", type=str, default="/root/results/sweep_lrtt_decay_200ep")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--decay-factor", type=float, default=1.0,
                        help="Decay factor for decay reinit (default: 1.0)")
...
def main():
    ...
    for te in te_values:
        ...
        print(f"    (reinit=decay, stem/head=FloatingPoint, 48 analog layers)")
