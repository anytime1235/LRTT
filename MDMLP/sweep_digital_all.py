#!/usr/bin/env python3
"""Optuna sweep: Digital MDMLP with all layers trainable (freeze-mode=none).

All 301,234 params trainable. Digital floating-point baseline.
...
Usage:
    python sweep_digital_all.py --n-trials 30 --epochs 30
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Sweep: digital, all layers trainable")
    ...
    parser.add_argument("--study-name", type=str, default="mdmlp_digital_all")
    parser.add_argument("--storage", type=str, default=None)
    parser.add_argument("--output-dir", type=str, default="./output/sweep_digital_all")
...
def objective(trial, args):
    """Train with all layers (freeze-mode=none)."""
    ...
    print(f"\n{'='*60}")
    print(f"[all-layers] Trial {trial.number}: lr={lr:.5f}")
    print(f"{'='*60}\n")
...
def main():
    ...
    print("\n" + "=" * 80)
    print("DIGITAL ALL-LAYERS SWEEP COMPLETE")
    print("=" * 80)
