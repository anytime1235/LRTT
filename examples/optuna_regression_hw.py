...
FIXED_A_LIFETIME_PER_BATCH = 60  # Batch 단위 lifetime (내부적으로 pulse 단위로 변환됨) - A device
FIXED_B_LIFETIME_PER_BATCH = 1000000 # B device lifetime (사실상 decay 없음)
...
DEFAULT_SEARCH_SPACE = {
    ...
    'lora_alpha': (0.0, 20.0),   # lora_alpha range (transfer LR)
