"""Figure 5(g): A/B (auxiliary) tile bit sweep — per-bit optimized, constantstepideal."""
import json
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
ax.legend(loc='lower left', fontsize=8.5, framealpha=0.9, edgecolor='0.7')
...
OUT = '/root/LRTT/examples/bert/results/plots/fig5g_ab_bit_sweep.png'
