"""Figure S11: Gamma ratio × w_max 2D sweep heatmaps — AF ratio = 0 vs AF ratio = 1."""
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
for ax, data, title, opt_key in [
    (ax1, f1_t267, 'Opt. at AF ratio = 0\n(constantstepideal, abml=10)', 'af0'),
    (ax2, f1_t249, 'Opt. at AF ratio = 1\n(6T1C-gamma, abml=12)', 'af1'),
]:
...
OUT = '/root/LRTT/examples/bert/results/plots/figS11_gamma_wmax_2d.png'
