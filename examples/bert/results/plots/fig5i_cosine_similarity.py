"""Figure 5(i): Cosine similarity — running average of alignment with descent direction."""
import json
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
OUT = '/root/LRTT/examples/bert/results/plots/fig5i_cosine_similarity.png'
