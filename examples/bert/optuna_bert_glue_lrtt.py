# -*- coding: utf-8 -*-
"""Optuna hyperparameter sweep for BERT + GLUE with LRTT.

Supported GLUE tasks: cola, sst2, mrpc, qqp, mnli, qnli, rte, stsb, wnli

Usage:
    python optuna_bert_glue_lrtt.py --task sst2 --n-trials 50
    python optuna_bert_glue_lrtt.py --task mrpc --n-trials 50
    python optuna_bert_glue_lrtt.py --task sst2 --visualize

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task rte --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 21 --warmup-steps 80 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task mrpc --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 14 --warmup-steps 80 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task stsb --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 16 --epochs 20 --warmup-steps 360 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task cola --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 16 --epochs 20 --warmup-steps 534 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task sst2 --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 20 --warmup-steps 2094 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task qnli --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 21 --warmup-steps 3312 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task qqp --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 128 --epochs 10 --warmup-steps 1400 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task mnli --optimizer AnalogSGD --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 128 --epochs 4 --warmup-steps 1000 --transfer-method set --no-io-noise --encoder-analog --head-analog --lora-target qkvo --n-trials 150

HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task rte --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 21 --warmup-steps 80 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task rte --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 21 --warmup-steps 80 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task mrpc --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 14 --warmup-steps 80 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task mrpc --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 14 --warmup-steps 80 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task stsb --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 16 --epochs 20 --warmup-steps 360 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task stsb --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 16 --epochs 20 --warmup-steps 360 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task cola --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 16 --epochs 20 --warmup-steps 534 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task cola --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 16 --epochs 20 --warmup-steps 534 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task sst2 --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 20 --warmup-steps 2094 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task sst2 --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 20 --warmup-steps 2094 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task qnli --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 21 --warmup-steps 3312 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task qnli --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 32 --epochs 21 --warmup-steps 3312 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task qqp --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 128 --epochs 10 --warmup-steps 1400 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task qqp --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 128 --epochs 10 --warmup-steps 1400 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task mnli --n-trials 150 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 128 --epochs 4 --warmup-steps 1000 --transfer-method set --no-io-noise --auto-scale-mode separate --lora-target qkvo
HF_HUB_DISABLE_XET=1 python optuna_bert_glue_lrtt.py --task mnli --n-trials 50 --optimizer AnalogAdam --reinit-mode hybrid --no-wd --no-momentum --no-nesterov --batch-size 128 --epochs 4 --warmup-steps 1000 --transfer-method set --no-io-noise --lora-target qkvo --no-transfer


All flags:
    python optuna_bert_glue_lrtt.py \
...
study = optuna.load_study(
    study_name='bert_sst2_lrtt_bs64_sgd_hybrid_nowd_nomom_nonest_set_noio_qkv',
    storage=JournalStorage(JournalFileBackend('results/optuna_bert_sst2_lrtt/optuna_bert_sst2_lrtt_bs64_sgd_hybrid_nowd_nomom_nonest_set_noio_qkv.log')))
study.enqueue_trial({
...
# Paths
RESULTS = os.path.join(os.getcwd(), "results", "optuna_bert_glue_lrtt")  # Updated per-task in main()
...
# reset_std defaults to True (split): A's reset is the inherent floor and B's
# reset_std is the random Gaussian σ source for gauss_b_* modes — these have
# different intended values. Toggle to False to sweep a shared ab_reset_std.
SPLIT_AB_PARAMS = {
    'dw_min': False,
    'multilevel': False,
    'tau_sec': False,
...
# than attention. Applied AT BUILD TIME via per-group convert_to_analog passes (a
# post-conversion override does NOT propagate to tiles), to each matched tile's
# forward+backward inp_res(DAC)/out_res(ADC). Example FFN 10-bit ADC: set
# 'intermediate'/'output.dense' adc=10.
LAYER_IO_BITS = {
...
def _create_ab_device(tau_sec=0.0, dw_min=0.001981, multilevel=None, device_name=None,
    ...
    Args:
        ...
        reset_std: σ for the reset (capacitor-discharge) operation. Used as the random
                   Gaussian source for B in gauss_b_* reinit modes (or A in gauss_a_*).
    """
    ...
    if name == "ideal":
        return IdealDevice()
    if name == "linearstep":
        return LinearStepDevice(dw_min=dw_min, lifetime=lifetime, reset_std=reset_std)
    ...
    if name == "constantstep":
        return ConstantStepDevice(dw_min=dw_min, lifetime=lifetime, reset_std=reset_std)
...
def create_lrtt_config(rank, transfer_every, transfer_lr, fast_lr, reinit_mode,
                       ...
                       a_reset_std=0.0, b_reset_std=0.0,
                       ab_desired_bl=31,
    ...
    caller passes the same value to both a_X and b_X (legacy ab_X behavior).
    """
    ...
    # Backward-compat shadow for legacy code paths below.
    ab_dw_min = a_dw_min
    ab_multilevel = a_multilevel
...
def create_model(params):
    ...
    if any_frozen_analog:
        ...
        if not _any_layer_io_override():
            ...
            # in all_linear_names, not in frozen_exclude (when HEAD_ANALOG), not an LRTT
            # target, and has no LAYER_IO_BITS key so _resolve_io_bits returns defaults.
...
def objective(trial, train_loader, eval_loader, tokenizer):
    ...
    if OPT_CONFIG['no_transfer']:
        ...
        if SPLIT_AB_PARAMS.get('tau_sec', False):
            ...
            ab_tau_sec = trial.suggest_float('tau_sec', 0, 0, log=False)
            a_tau_sec = b_tau_sec = ab_tau_sec

    # A/B dw_min: per-tile splittable. SPLIT_AB_PARAMS['dw_min']=False sweeps a single
    # ab_dw_min applied to both tiles (legacy behavior).
    if SPLIT_AB_PARAMS.get('dw_min', False):
        a_dw_min = trial.suggest_float('a_dw_min', 2e-5, 2e-1, log=True)
        b_dw_min = trial.suggest_float('b_dw_min', 2e-5, 2e-1, log=True)
    else:
        ab_dw_min = trial.suggest_float('ab_dw_min', 2e-5, 2e-1, log=True)
        a_dw_min = b_dw_min = ab_dw_min

    # desired_bl: per-tile splittable.
    if SPLIT_AB_PARAMS.get('desired_bl', False):
        ...
        ab_desired_bl = a_desired_bl  # placeholder for legacy code paths
    else:
        ab_desired_bl = trial.suggest_int('ab_desired_bl', 31, 31)
        a_desired_bl = b_desired_bl = None
    ...
    if OPT_CONFIG.get('ab_multilevel', False):
        if SPLIT_AB_PARAMS.get('multilevel', False):
            a_multilevel = trial.suggest_int('a_multilevel', 1, 12)
            b_multilevel = trial.suggest_int('b_multilevel', 1, 12)
        else:
    ...
    # reset_std: per-tile splittable (B's reset_std is the random Gaussian σ for
    # gauss_b_* reinit modes; A's is for gauss_a_*; otherwise unused).
    if SPLIT_AB_PARAMS.get('reset_std', False):
        a_reset_std = trial.suggest_float('a_reset_std', 1e-30, 1e-30, log=False)
        b_reset_std = trial.suggest_float('b_reset_std', 1e5, 1e5, log=False)
    else:
    ...
    # weight_scaling_omega: per-tile splittable via mapping_a/mapping_b. Default shared.
...
def main():
    global TASK_NAME, NUM_LABELS, BATCH_SIZE, GRAD_ACCUM_STEPS, N_EPOCHS, WARMUP_STEPS, TRANSFER_METHOD, AB_DEVICE, A_DEVICE, B_DEVICE, C_DEVICE, IO_NOISE, FORWARD_INJECT, IS_PERFECT, NO_QUANT, LORA_TARGET, HEAD_LAYER, ENCODER_ANALOG, HEAD_ANALOG, BACKWARD_INP_BOUND, BACKWARD_OUT_BOUND
    ...
    RESULTS = os.path.join(os.getcwd(), "results", f"optuna_bert_{TASK_NAME}_lrtt")
