#!/usr/bin/env python
# coding=utf-8
"""BERT-base LRTT Bayesian Hyperparameter Search with Optuna.
...
WANDB_PROJECT = "lrtt-bert-base-optuna"
...
def main():
    ...
    study_name = args.study_name or f"lrtt_bert_base_{timestamp}"

    print("=" * 60)
    print("BERT-base LRTT Bayesian Search (Optuna)")
    print("=" * 60)
