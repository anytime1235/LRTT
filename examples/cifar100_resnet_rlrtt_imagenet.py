...
"""aihwkit example: ResNet18 CNN with CIFAR100 using LRTT layers + ImageNet pretrained weights.

CIFAR100 dataset on a ResNet18 network using LRTT (Low-Rank Tensor-Train)
...
RESULTS = os.path.join(os.getcwd(), "results", "RESNET_REGULAR_LRTT_IMAGENET_CIFAR100")
os.makedirs(RESULTS, exist_ok=True)
WEIGHT_PATH = os.path.join(RESULTS, "cifar100_resnet_regular_lrtt_imagenet_model_weight.pth")
...
def main():
    ...
    # Initialize wandb
    wandb.init(
        project="new_cifar100_resnet18_regularlrtt_imagenet",
