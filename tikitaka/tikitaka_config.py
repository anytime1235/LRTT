...
This is the training-optimized version for baseline experiments.
"""
...
def create_sixt1c_device(
    ...
    write_noise_std: float = 0.0,  # Default 0 for baseline experiments
    lifetime: float = 0.0,
) -> LinearStepDevice:
...
def tikitaka_sixt1c_softbounds_config(
    ...
    sixt1c_write_noise_std: float = 0.0,  # Default 0 for baseline experiments
