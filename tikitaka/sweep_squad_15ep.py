#!/usr/bin/env python
# coding=utf-8
"""SQuAD 15-Epoch Optimized Sweep with TikiTaka v2.

Key changes from sweep_tikitaka_all_tasks.py:
  1. B tile: SoftBoundsReferenceDevice with noise=0 (all perturbations disabled)
  2. LR scheduler: Cosine with min_lr (floor at 10% of peak LR)
  3. Search space: Narrowed around 1-epoch & 3-epoch best, defaults included
  4. Early stopping: Patience=3 on eval F1
  5. Warm-start: 3-epoch best params enqueued as first trial
"""
...
WANDB_PROJECT = "tikitaka-squad-15ep-sweep"
OUTPUT_DIR = "/data/LRTT_transformer/tikitaka/results"

# =============================================================================
# Search Space (15-epoch optimized)
# =============================================================================

LR_MIN, LR_MAX = 5e-5, 5e-4
TRANSFER_LR_MIN, TRANSFER_LR_MAX = 0.1, 3.0
TRANSFER_EVERY_MIN, TRANSFER_EVERY_MAX = 1, 200
FAST_LR_MIN, FAST_LR_MAX = 0.1, 1.5
AUTO_GRAN_MIN, AUTO_GRAN_MAX = 100, 600
CHOP_PROB_MIN, CHOP_PROB_MAX = 0.01, 0.15

# 3-epoch best params (Trial 42) - warm start
WARM_START_PARAMS = {
    "learning_rate": 0.000362,
    "transfer_lr": 0.783,
    "transfer_every": 123,
    "fast_lr": 0.174,
    "auto_granularity": 517,
    "in_chop_prob": 0.047,
}
...
def get_cosine_with_min_lr_schedule_with_warmup(
    ...
    This prevents LR from reaching 0, maintaining learning capacity in later
    epochs to counteract analog tile weight erosion.
    """
    def lr_lambda(current_step: int) -> float:
        ...
        # Scale so LR goes from 1.0 down to min_lr_rate (not 0)
...
def main():
    ...
    results_dir = os.path.join(OUTPUT_DIR, f"squad_15ep_sweep_{modules_tag}_{timestamp}")
    ...
    print(f"LR scheduler: cosine with min_lr_rate={MIN_LR_RATE}")
