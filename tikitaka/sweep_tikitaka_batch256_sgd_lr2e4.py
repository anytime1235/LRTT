...
TRANSFER_LR_MIN, TRANSFER_LR_MAX = 0.01, 4.0
FAST_LR_MIN, FAST_LR_MAX = 0.1, 5.0
TRANSFER_EVERY_MIN, TRANSFER_EVERY_MAX = 10, 1000
FIXED_AUTO_GRANULARITY = 169.0
FIXED_IN_CHOP_PROB = 0.061

# Warm start — SST-2 best (Trial 33) with lr=2e-4
WARM_START_PARAMS = {
...
# NOTE: SST-2 best (Trial 33, AnalogAdam sweep, acc=0.9014)
...
GLUE_EPOCHS = 6               # GLUE: 6 epochs (extended for STS-B convergence)
...
WANDB_PROJECT = "tikitaka-v2-sgd-sweep-50t"
...
def create_glue_model(task_name: str, params: Dict, device: torch.device) -> nn.Module:
    ...
    for name, param in model.named_parameters():
        ...
        if is_classifier:
            param.requires_grad = True  # classifier weight + bias both trainable
        elif "bias" in name:
