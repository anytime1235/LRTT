...
import sweep_tikitaka_batch256_te_extended as _sweep
# Override batch sizes to 32
_sweep.BATCH_SIZE = 32
_sweep.EVAL_BATCH_SIZE = 32
from sweep_tikitaka_batch256_te_extended import (
    MODEL_NAME, SEED, MIN_LR_RATE, WANDB_PROJECT,
...
def main():
    ...
    results_dir = f"/data/LRTT_transformer/tikitaka/results/single_sgd_no_transfer_{timestamp}"
    os.makedirs(results_dir, exist_ok=True)

    print("=" * 60)
    print(f"Single Run: AnalogAdam NO TRANSFER (te=1e9)")
    print("=" * 60)
    ...
    print(f"Optimizer: AnalogAdam (lr={PARAMS['learning_rate']:.6f})")
