...
# coding=utf-8
"""Run LRTT with best hybrid conditions for 15 epochs (COSINE ANNEALING).

Uses CosineAnnealingLR instead of linear warmup+decay.
No warmup - pure cosine decay from max lr to 0.
...
# =============================================================================
# Cosine Schedule with Min LR (from sweep_squad_15ep.py)
# =============================================================================
...
WARMUP_STEPS = 500
SEED = 42
WANDB_PROJECT = "lrtt-best-15ep-cosine"
...
def run_task(task_name, num_epochs, device, results_dir):
    ...
    scheduler = get_cosine_with_min_lr_schedule_with_warmup(
        optimizer, WARMUP_STEPS, num_training_steps, min_lr_rate=MIN_LR_RATE
    )
    ...
    out_file = os.path.join(task_dir, f"best_hybrid_{num_epochs}ep_cosine.json")
