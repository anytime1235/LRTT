...
# coding=utf-8
"""Sixt1c-LoRA Bayesian Optimization for SQuAD - RANK 8 (AnalogSGD).

Sixt1c-LoRA mode: forward_inject=True, no transfer (transfer_every=1000000).
Search space: learning_rate, lora_alpha, momentum.
...
def run_trial(trial: optuna.Trial, train_loader, eval_loader,
    ...
    # Sample hyperparameters: lr, lora_alpha, momentum
    params = {
...
def main():
    ...
    print(f"  momentum: {DEFAULT_PARAMS['momentum']}")
